      ...
      if (score != null) {
        if (score != "You are not teacher in this class") {
          ...
          score.forEach((object) => {
            if (object.status.includes("Chưa nộp học phí"))
  ...
  return (
    <div className="p-4" style={{ overflow: "auto" }}>
      <center style={{ padding: -0.25 }}>
        <Card
          title="Bảng theo dõi"
          style={{ width: 1200, height: 1400, overflow: "auto" }}
        >
          <Row justify="center">
            ...
            <Col>
              <div className="p-4">
                <Card style={{ width: 600, height: 220 }} hoverable>
                  <span style={{ "font-size": "17px" }}>Lớp hiện tại</span>
                  <br />
                  <h3>{dashProperties.className}</h3>
                  <br />
                  <span style={{ "font-size": "17px" }}>Cố vấn học tập</span>
                  <h3>{dashProperties.teacherName}</h3>
                  <br />
                </Card>
              </div>
            </Col>
            ...
            <Col>
              <div className="p-4">
                <Card style={{ width: 300, height: 220 }} hoverable>
                  <span style={{ "font-size": "17px" }}>Sĩ số lớp</span>
                  <br />
                  <span
                    style={{ "font-size": "48px", "line-height": "normal" }}
                  >
                    {dashProperties.studentCount}
                  </span>
                  <br />
                  <span
                    style={{ "font-size": "27px", "line-height": "normal" }}
                  >
                    {" "}
                    sinh viên
                  </span>
            ...
            <Col>
              <div className="p-4">
                ...
                <Row>
                  <Card style={{ width: 300, height: 220 }} hoverable>
                    <span style={{ "font-size": "17px" }}>
                      Sinh viên thiếu tín chỉ
                    </span>
                    <br />
                    <span
                      style={{ "font-size": "48px", "line-height": "normal" }}
                    >
                      {dashProperties.studentThieuTinChi}
                    </span>
                    <br />
                    <span
                      style={{ "font-size": "27px", "line-height": "normal" }}
                ...
                <Row>
                  <Card style={{ width: 300, height: 220 }} hoverable>
                    <span style={{ "font-size": "17px" }}>
                      Sinh viên thiếu học phí
                    </span>
                    <br />
                    <span
                      style={{ "font-size": "48px", "line-height": "normal" }}
                    >
                      {dashProperties.studentThieuHocPhi}
                    </span>
                    <br />
                    <span
                      style={{ "font-size": "27px", "line-height": "normal" }}
          ...
          <StatisticBoard score={score}></StatisticBoard>
        </Card>
      </center>
    </div>
  );
