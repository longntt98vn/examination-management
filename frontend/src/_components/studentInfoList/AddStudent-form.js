...
function AddStudentForm(props) {
  ...
  return (
    <div>
      ...
      >
        <i>Thêm nhiều sinh viên cách nhau bằng dấu ','</i>
        <br />
        <i>
          Sinh viên được thêm vào lớp phải có tài khoản VNU được cấp bởi admin
          của hệ thống.
        </i>
        <br />
        <br />
      ...
      <i>Thêm sinh viên vào lớp bằng file danh sách email.</i>
      <br />
      <i>
        Sinh viên được thêm vào lớp phải có tài khoản VNU được cấp bởi admin của
        hệ thống.
      </i>
      <br />
      <br />
      <UploadForm
        columns={upload_form}
        formurl={
          classWrapper.curClass != null
            ? "http://localhost:3000/api/classes/" +
              classWrapper.curClass.class_id +
              "/members/import/"
            : ""
        }
      />
