      ...
      <Row>
        <Col flex="250px">
          ...
          <div>
            ...
            <br />
            <i>
              Nhấn nút lọc ở cột <b>Kì học</b> để
            </i>
            <br />
        ...
        <Col flex="auto">
          <Table
            columns={
              scoreType.decimal === true
                ? columns.filter((col) => col.dataIndex !== "scoref")
                : columns.filter((col) => col.dataIndex !== "score")
            }
                  ...
                  <Table.Summary.Row>
                    ...
                    <Table.Summary.Cell>
                      <Text>
                        <b>
                          {scoreType.decimal === true
                            ? (summScore / summCredit).toFixed(2)
                            : ((summScore / summCredit / 10) * 4).toFixed(2)}
                        </b>
                      </Text>
                    </Table.Summary.Cell>
                    <Table.Summary.Cell />
