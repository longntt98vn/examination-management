...
function StatisticBoard(props) {
  ...
  const [levelStatus, setlevelStatus] = useRecoilState(
    dashboardLevelStatusAtom,
  );
          ...
          props.score.forEach((object) => {
            ...
            tempStatus.Warning =
              GPA < 2.5 && GPA >= 1.0
                ...
                : tempStatus.Warning;
            tempStatus.Expelling =
              GPA < 1.0 && GPA >= 0
                ? tempStatus.Expelling + 1
                : tempStatus.Expelling;
          });
        }
      }
      var statusVisualized = [];
      statusVisualized.push({
        name: "Bình thường",
        BinhThuong: tempStatus.Normal,
      });
      statusVisualized.push({ name: "Cảnh cáo", CanhCao: tempStatus.Warning });
      statusVisualized.push({
        name: "Đuổi học",
        DuoiHoc: tempStatus.Expelling,
      });
  ...
  return (
    <div className="p-4">
      <Card
        title="Thống kê tình hình học tập"
      ...
      >
        ...
        <Row justify="center">
          <BarChart width={640} height={420} data={levelStatus.data}>
