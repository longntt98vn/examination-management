...
const Post = ({
  ...
  if (likedList.length > 2) likedForRender += "... + " + (likedList.length - 2);
  if (likedForRender != "") {
    ...
    <Grid container className="post">
      ...
      <Grid item xs={10.9} sm={10.9} className="postTopInfo">
        <Grid container className="postTopInfo">
          <Grid item xs={12}>
            <h5 className="postUsername">{post.from.name}</h5>
          </Grid>
          <Grid item xs={12}>
      ...
      <Grid item xs={11.5} onClick={showListLiked_} style={{ color: "gray" }}>
        {likedForRender}
      </Grid>
      <Grid item xs={12}>
          ...
          <Grid item xs={11.9}>
            <Grid container className="commentCtn">
              <Grid item xs={1} className="avatarCommentInput">
                <Avatar
                  {...stringAvatar(userData.name ? userData.name : "You")}
                  className="commentAvatar"
                />
              </Grid>
