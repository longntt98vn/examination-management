...
function DBPortal() {
  return (
    <div className="p-4" style={{ overflow: "auto" }}>
      ...
      <i>
        {" "}
        Nơi tải lên dữ liệu sinh viên, điểm số, kì học dành cho Cố vấn học
        tập{" "}
      </i>
      <br />
      <br />
      ...
      <Row>
        <Col flex="300px">
          ...
          <i>
            {" "}
            Tải danh sách tài khoản và thông tin Cố vấn học tập lên hệ
            thống.{" "}
          </i>
          <br />
          <br />{" "}
          <UploadForm
            columns={upload_form_teacher}
            formurl="http://localhost:3000/api/upload/dscv"
          />{" "}
          <br />
        </Col>
        <Col flex="300px">
          ...
          <UploadForm
            ...
            formurl="http://localhost:3000/api/upload/dssv"
          />{" "}
          <br />
          <i>
            <b>Lưu ý:</b> Các sinh viên sẽ chưa được thêm lớp. Yêu cầu CVHT tạo
            lớp và thêm tại bảng Thông tin SV.{" "}
          </i>
          <br />
        </Col>
        <Col flex="300px">
          ...
          <br />
          <UploadForm
            columns={upload_form_subject}
            formurl="http://localhost:3000/api/upload/dsmh"
          />
        </Col>
        <Col flex="auto"></Col>
      </Row>
      ...
      <Row>
        <Col flex="300px">
          ...
          <br />{" "}
          <UploadForm
            columns={upload_form_semester}
            formurl="http://localhost:3000/api/semesters/upload"
          />
        </Col>
        <Col flex="300px">
          ...
          <br />
          <UploadForm
            columns={upload_score_student}
            formurl="http://localhost:3000/api/scores/import"
          />
        </Col>
        <Col flex="300px">
          ...
          <UploadForm
            ...
            formurl="http://localhost:3000/api/status/import"
          />
        </Col>
        <Col flex="auto"></Col>
      </Row>
