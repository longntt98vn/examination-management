  ...
  return (
    <div>
      ...
      >
        ...
        />{" "}
        Dữ liệu thêm thành công: <b>{result.registered.length}</b>
        <br />
        <CloseCircleTwoTone
          twoToneColor="#eb2f96"
          style={{
        ...
        />{" "}
        Dữ liệu thêm thất bại: <b>{result.failed.length}</b>
        <br />
        <br />
        {/* <Tree
            treeData={result}
        ...
        {props.columns && (
          <Table
            ...
            dataSource={result.registered}
          />
        )}
        <b>Thất bại:</b>
        {/* <TextArea rows={10} value = {log} style={{ resize: "none"}} /> */}
        {props.columns && (
          <Table columns={props.columns} dataSource={result.failed} />
        )}
      </Modal>
      <Upload {...cprops}>
