                      ...
                      <Card hoverable style={{ width: 500, height: 310 }}>
                        ...
                        <h4>
                          {classWrapper.curClass
                            ? classWrapper.curClass.class_name
                ...
                {classWrapper.curClass && (
                  <>
                    ...
                    <Row>
                      <Col flex="260px">
                        <Link
                          to={`/${classWrapper.curClass.class_id}/studentinfo`}
                        >
                    ...
                    <Row>
                      ...
                      <Col flex="260px">
                        <Link
                          to={`/${classWrapper.curClass.class_id}/studentscore`}
                        >
                          <Card hoverable style={{ width: 240 }}>
                            <LayoutTwoTone
                              twoToneColor="#52c41a"
          ...
          <>
            {studentFirstClassLoaded && !classWrapper.curClass && (
              <>
                <div className="p-4">
                  <div className="container">
                    <h1>Xin chào, bạn là sinh viên nhưng chưa có lớp!</h1>
                    <br></br>
                    <h5>
                      Vui lòng liên hệ với admin hệ thống và nhà trường để được
                      thêm vào trang lớp học của bạn.
                    </h5>
                  </div>
                </div>
              </>
